...
def _full_signal_payload(signal: dict) -> str:
    ...
    payload = {
        ...
        "risk_pct_used":       signal.get("risk_pct_used"),
        "risk_amount_usdt":    signal.get("risk_amount_usdt"),
        "margin_required_usdt": signal.get("margin_required_usdt"),
        "sizing_skip_reason":  signal.get("sizing_skip_reason"),
        "sl_pct_raw":          signal.get("sl_pct_raw"),
        "sl_pct_used":         signal.get("sl_pct_used"),
        "min_sl_pct_applied":  signal.get("min_sl_pct_applied"),
        "short_confidence":    signal.get("short_confidence"),
        "regime_price":        signal.get("regime_price"),
        "regime_ema":          signal.get("regime_ema"),
        "regime_timeframe":    signal.get("regime_timeframe"),
        "regime_period":       signal.get("regime_period"),
